...
start_conn_time = time.time() * 1000
...
end_conn_time = time.time() * 1000
conn_proc_time = end_conn_time - start_conn_time

time_str = "PROC_TIME: [%dms], [%ds] [%dmin] [%dh]" % \
	(conn_proc_time, conn_proc_time / 1000., conn_proc_time / 1000. / 60, conn_proc_time / 1000. / 3600)
